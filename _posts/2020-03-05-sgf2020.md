...
Next, the same work in PROC Logselect triggers using the regression. Logistic action in PROC CAS.  The selection method and the model is specified to consider all pairwise interactions, a unique feature of the action.  
